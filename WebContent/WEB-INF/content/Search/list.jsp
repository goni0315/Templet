    ...
    <div class="bbsCont" style="margin:5px 0px 10px 10px; width:282px;">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" summary="목록" >
		...
		<tr>
          ...
          <td style="font-size:12px; line-height: 1.4em;">수원시 ${board.sgg_nm} ${board.emd_nm} ${board.jibun}</td>
          <td><img src="./images/common/btn_move.gif" width="41" height="15" onclick="parent.parent.searchXYGo(${board.x_point}, ${board.y_point})" style="cursor: pointer" ></td>	
		</tr>
		</c:forEach>
		</c:if>
